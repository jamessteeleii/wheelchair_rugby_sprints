...
\left(
  \begin{array}{c} 
    \begin{aligned}
      &\gamma_{0}^{\alpha} + \gamma_{1}^{\alpha}(\operatorname{group{diff}}_{\operatorname{SCI}}) \\
      &\gamma^{\beta_{1}}_{0} + \gamma^{\beta_{1}}_{1}(\operatorname{group{diff}}_{\operatorname{SCI}}) \\
      &\gamma^{\beta_{2}}_{0} + \gamma^{\beta_{2}}_{1}(\operatorname{group{diff}}_{\operatorname{SCI}}) \\
      &\gamma^{\beta_{3}}_{0} + \gamma^{\beta_{3}}_{1}(\operatorname{group{diff}}_{\operatorname{SCI}})
    \end{aligned}
  \end{array}
\right)
, 
...
\begin{aligned}
  \operatorname{time}_{i}  &\sim N \left(\mu, \sigma^2 \right) \\
    \mu &=\alpha_{j[i]} + \beta_{1j[i]}(\operatorname{sprint number}) + \beta_{2j[i]}(\operatorname{distance}_{\operatorname{5-10m}}) + \beta_{3j[i]}(\operatorname{distance}_{\operatorname{10-15m}})\ + \\
&\quad \beta_{4j[i]}(\operatorname{distance}_{\operatorname{15-20m}}) + \beta_{5}(\operatorname{distance}_{\operatorname{5-10m}} \times \operatorname{sprint number}) + \beta_{6}(\operatorname{distance}_{\operatorname{10-15m}} \times \operatorname{sprint number}) + \beta_{7}(\operatorname{distance}_{\operatorname{15-20m}} \times \operatorname{sprint number}) \\    
\left(
  \begin{array}{c} 
    \begin{aligned}
      &\alpha_{j} \\
...
\left(
  \begin{array}{c} 
    \begin{aligned}
      &\gamma_{0}^{\alpha} + \gamma_{1}^{\alpha}(\operatorname{group{diff}}_{\operatorname{5}}) \\
      &\gamma^{\beta_{1}}_{0} + \gamma^{\beta_{1}}_{1}(\operatorname{group{diff}}_{\operatorname{5}}) \\
      &\gamma^{\beta_{2}}_{0} + \gamma^{\beta_{2}}_{1}(\operatorname{group{diff}}_{\operatorname{5}}) + \gamma^{\beta_{2}}_{2}(\operatorname{group{diff}}_{\operatorname{5}} \times \operatorname{sprint number}) \\
      &\gamma^{\beta_{3}}_{0} + \gamma^{\beta_{3}}_{2}(\operatorname{group{diff}}_{\operatorname{5}}) + \gamma^{\beta_{3}}_{1}(\operatorname{group{diff}}_{\operatorname{5}} \times \operatorname{sprint number}) \\
      &\gamma^{\beta_{4}}_{0} + \gamma^{\beta_{4}}_{1}(\operatorname{group{diff}}_{\operatorname{5}}) + \gamma^{\beta_{4}}_{2}(\operatorname{group{diff}}_{\operatorname{5}} \times \operatorname{sprint number})
    \end{aligned}
  \end{array}
\right)
, 
